...
static inline void zmt_swizzleSelector(Class class, SEL originalSelector, SEL swizzledSelector) {
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        zmt_swizzleSelector(class, @selector(descriptionWithLocale:), @selector(printlog_descriptionWithLocale:));
        zmt_swizzleSelector(class, @selector(descriptionWithLocale:indent:), @selector(printlog_descriptionWithLocale:indent:));
        zmt_swizzleSelector(class, @selector(debugDescription), @selector(printlog_debugDescription));
    });
}
