...
- (NSArray<WWRuntimeObjectModel *> *)propertyListInDetail {
    NSMutableArray<WWRuntimeObjectModel *> *list = [NSMutableArray array];
    ...
    for (unsigned int i = 0; i < count; i++) {
        ...
        WWRuntimeObjectModel *object = [[WWRuntimeObjectModel alloc] init];
...
- (NSArray<WWRuntimeObjectModel *> *)ivarListInDetail {
    NSMutableArray<WWRuntimeObjectModel *> *list = [NSMutableArray array];
...
- (NSArray<WWRuntimeObjectModel *> *)allListInDetail {
...
- (void)cleanAllProperyValue {
    NSArray<WWRuntimeObjectModel *> *propertyList = self.propertyListInDetail;
    
    for (WWRuntimeObjectModel *object in propertyList) {
...
- (void)cleanAllIvarValue {
    NSArray<WWRuntimeObjectModel *> *ivarList = self.ivarListInDetail;
    
    for (WWRuntimeObjectModel *object in ivarList) {
        if (object.type == PropertyType_NSNumber) {
            [self setValue:@(0) forKey:object.name];
        }
        else{
