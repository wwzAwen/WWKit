...
- (id)runtime_delegate {
    ...
    if (temp == nil) {
        ...
        Class subClass = [WWRunTime newSubClassWithName:subClassName base:[NSObject class]];
...
- (void)addInstanceMethod:(nonnull SEL)selector block:(id)block {
    ...
    if (![className hasSuffix:hashStr]) {
        ...
        Class subClass = [WWRunTime newSubClassWithName:subClassName base:[self class]];
...
- (void)exchangeInstanceMethodWithOriginalSel:(SEL)originalSelector
    ...
    [WWRunTime exchangeInstanceMethodWithOriginalClass:[self class]
