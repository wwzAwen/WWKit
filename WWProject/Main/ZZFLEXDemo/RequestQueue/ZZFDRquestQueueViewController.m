...
#import <WWKit/UIScrollView+ZMT.h>

#define     RQVC_HEIGHT_TEXTVIEW            MIN(200, kScreenHeight * 0.35)
...
- (void)loadView
{
    ...
    tipLabel.zz_setup.frame(CGRectMake(0, 0, kScreenWidth, kScreenHeight - kNavigationBarHeight - kStatusBarHeight - RQVC_HEIGHT_TEXTVIEW)).userInteractionEnabled(YES)
