...
#import <WWKit/WWActionSheetTool.h>
#import <WWKit/NSString+URL.h>
...
- (void)loadView
{
    ...
    [self addRightBarButtonWithTitle:[NSString stringWithFormat:@"%@", version] actionBlick:^{
        WWActionSheetTool *actionSheet = [[WWActionSheetTool alloc] initWithTitle:[NSString stringWithFormat:@"当前版本号：%@", version] clickAction:^(NSInteger buttonIndex) {
            if (buttonIndex == 0) {
