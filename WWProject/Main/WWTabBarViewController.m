...
#import <WWKit/WWBaseViewController.h>
#import <WWKit/WWBaseNavigationViewController.h>
#import <WWKit/WWKit.h>
@interface WWTabBarViewController ()

@property (nonatomic,strong) WWMainViewController *viewController1;
...
- (void)viewDidLoad {
    ...
    self.viewController1 = [[WWMainViewController alloc]init];
    WWBaseNavigationViewController *nav1 = [[WWBaseNavigationViewController alloc]initWithRootViewController:self.viewController1];
    nav1.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"首页1" image:[[UIImage imageNamed:@"AppIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"AppIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
    ...
    self.viewController3 = [[WWBaseViewController alloc]init];
    WWBaseNavigationViewController *nav3 = [[WWBaseNavigationViewController alloc]initWithRootViewController:self.viewController3];
    nav3.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"首页3" image:[[UIImage imageNamed:@"AppIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] selectedImage:[[UIImage imageNamed:@"AppIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
