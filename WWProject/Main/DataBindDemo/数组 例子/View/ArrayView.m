...
- (void)awakeFromNib {
    ...
    self.btnChange1.backgroundImageForHighlighted = [UIImage imageWithColor:[UIColor darkGrayColor]];
    
    self.btnChange2.titleColor = [UIColor whiteColor];
    self.btnChange2.backgroundImage = [UIImage imageWithColor:[UIColor Blue]];
    self.btnChange2.backgroundImageForHighlighted = [UIImage imageWithColor:[UIColor darkGrayColor]];
}
